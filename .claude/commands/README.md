...
| UX | API consistency, error messages, developer experience | `ux_expert_plan`, `ux_expert_review`, `ux_expert_improve` |
| CC Hook | Pre-commit hooks, automation, CI/CD integration | `cc_hook_expert_plan`, `cc_hook_expert_review`, `cc_hook_expert_improve` |
| Claude Config | CLAUDE.md accuracy, command documentation, navigation | `claude_config_plan`, `claude_config_review`, `claude_config_improve` |
