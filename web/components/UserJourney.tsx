export default function UserJourney() {
	const steps = [
		...
		},
		{
			...
			description:
				"Free tier gives you 100 requests/hour to start. Upgrade as you grow",
		},
		{
			number: "3",
			title: "Watch Your AI Get Smarter",
			description:
				"Paste your key into Claude Code. Instantly, your AI can search thousands of files, map dependencies, and validate changes—no more guessing",
		},
	];
